...
public class CategoryBean {
	...
	private Set<BaseBean> ca_CompanyBean;
	...
	public Set<BaseBean> getCa_CompanyBean() {
		return ca_CompanyBean;
	}

	public void setCa_CompanyBean(Set<BaseBean> ca_CompanyBean) {
		this.ca_CompanyBean = ca_CompanyBean;
	}
