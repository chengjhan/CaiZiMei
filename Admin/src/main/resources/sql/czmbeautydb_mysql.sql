...
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '曼星整形醫美診所', 'Twinkle Clinic', '02', '27079333', 1, 11, 102, '大安區信義路四段58號3F-2', 25.033072, 121.545437, 'http://twinkle-clinic.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '晶鑽時尚診所-台北', 'Diamond Cosmetic', '02', '27665066', 1, 11, 102, '信義區忠孝東路4段563號3F', 25.041589, 121.564050, 'http://diamondcosmetic.com.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '晶鑽時尚診所-台中', 'Diamond Cosmetic', '02', '23195800', 1, 11, 108, '西區公益路130號B1', 24.151141, 120.660487, 'http://diamondcosmetic.com.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '晶鑽時尚診所-高雄', 'Diamond Cosmetic', '02', '2367811', 1, 11, 115, '新興區中正三路156號', 22.631456, 120.304368, 'http://diamondcosmetic.com.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '法泊時尚診所-台北', 'Fabulous Clinic', '02', '27199010', 1, 11, 102, '松山區復興北路311號3樓', 25.058785, 121.544431, 'http://www.fabulous-clinic.com', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '法泊時尚診所-高雄', 'Fabulous Clinic', '02', '5585838', 1, 11, 115, '左營區博愛二路656號', 22.669675, 120.303546, 'http://www.fabulous-clinic.com', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '喬雅時尚診所', 'Joya Clinical Beauty', '02', '27715833', 1, 11, 102, '大安區忠孝東路四段147巷1號10樓', 25.041839, 121.544056, 'http://www.joya-beauty.com.tw', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '好萊塢診所-台北仁愛', 'Hollywood', '02', '27717771', 1, 11, 102, '大安區仁愛路四段105巷5號', 25.038633, 121.550189, 'http://hollywood.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '好萊塢診所-台北忠孝', 'Hollywood', '02', '27315900', 1, 11, 102, '大安區忠孝東路四段94號2樓之1', 25.041701, 121.545949, 'http://hollywood.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '好萊塢診所-台北復興', 'Hollywood', '02', '27519600', 1, 11, 102, '大安區忠孝東路三段283號2樓', 25.042171, 121.542878, 'http://hollywood.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '好萊塢診所-台北南西', 'Hollywood', '02', '25622701', 1, 11, 102, '中山區南京東路一段24號3樓', 25.052305, 121.523649, 'http://hollywood.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '好萊塢診所-台北光復', 'Hollywood', '02', '27786800', 1, 11, 102, '大安區光復南路260巷23號3樓', 25.040441, 121.556414, 'http://hollywood.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '好萊塢診所-台北南港', 'Hollywood', '02', '27828200', 1, 11, 102, '南港區三重路26號1樓', 25.056361, 121.614177, 'http://hollywood.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '好萊塢診所-桃園', 'Hollywood', '03', '3263123', 1, 11, 104, '桃園區新埔六街38號1樓', 25.014528, 121.302752, 'http://hollywood.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '好萊塢診所-台中', 'Hollywood', '04', '22595825', 1, 11, 108, '西屯區市政北一路1號2樓', 24.157116, 120.646442, 'http://hollywood.tw/', now(), now(), 1, now());
insert into base (ba_ca_id, ba_name, ba_eng_name, ba_tel_code, ba_tel, ba_co_id, ba_st_id, ba_ci_id, ba_address, ba_latitude, ba_longitude, ba_url, ba_insert_time, ba_update_time, ba_status, ba_status_time) values (1, '璀璨精品牙醫診所', 'Dazzling Dental Clinic', '02', '28721239', 1, 11, 102, '士林區天玉街41號', 25.121355, 121.529410, 'http://www.dazzlingdental.com.tw/', now(), now(), 1, now());
...
-- image
insert into image (im_ca_id, im_name, im_path, im_filename, im_url, im_rank, im_status, im_update_time) values (8, '曼星整形醫美診所', '/Users/chengjhan/Desktop/Case/CaiZiMei/apache-tomcat-8.0.41/wtpwebapps/Admin/images/slider-main/', 'clinic_twinkle_clinic_1000x380.jpg', 'http://twinkle-clinic.tw', 1, 1, now());
insert into image (im_ca_id, im_name, im_path, im_filename, im_url, im_rank, im_status, im_update_time) values (8, '晶鑽時尚診所', '/Users/chengjhan/Desktop/Case/CaiZiMei/apache-tomcat-8.0.41/wtpwebapps/Admin/images/slider-main/', 'clinic_diamondcosmetic_1000x380.jpg', 'http://diamondcosmetic.com.tw/', 2, 1, now());
insert into image (im_ca_id, im_name, im_path, im_filename, im_url, im_rank, im_status, im_update_time) values (8, '法泊時尚診所', '/Users/chengjhan/Desktop/Case/CaiZiMei/apache-tomcat-8.0.41/wtpwebapps/Admin/images/slider-main/', 'clinic_fabulous_clinic_1000x380.png', 'http://www.fabulous-clinic.com', 3, 1, now());
insert into image (im_ca_id, im_name, im_path, im_filename, im_url, im_rank, im_status, im_update_time) values (8, '喬雅時尚診所', '/Users/chengjhan/Desktop/Case/CaiZiMei/apache-tomcat-8.0.41/wtpwebapps/Admin/images/slider-main/', 'clinic_joya_beauty_1000x380.png', 'http://www.joya-beauty.com.tw', 4, 1, now());
insert into image (im_ca_id, im_name, im_path, im_filename, im_url, im_rank, im_status, im_update_time) values (8, '好萊塢診所', '/Users/chengjhan/Desktop/Case/CaiZiMei/apache-tomcat-8.0.41/wtpwebapps/Admin/images/slider-main/', 'clinic_hollywood_1000x380.jpg', 'http://hollywood.tw/', 5, 1, now());
insert into image (im_ca_id, im_name, im_path, im_filename, im_url, im_rank, im_status, im_update_time) values (8, '何彬彬牙醫診所', '/Users/chengjhan/Desktop/Case/CaiZiMei/apache-tomcat-8.0.41/wtpwebapps/Admin/images/slider-main/', 'clinic_1637_1000x380.jpg', 'http://1637.tw/07-2270748/', 6, 1, now());

-- video
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (11, 'aaa', '<iframe width="560" height="315" src="https://www.youtube.com/embed/C589vlQLQEA" frameborder="0" allowfullscreen></iframe>', 1, 1, now());
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (11, 'bbb', '<iframe width="560" height="315" src="https://www.youtube.com/embed/zXvg00_5OpM" frameborder="0" allowfullscreen></iframe>', 2, 0, now());
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (11, 'ccc', '<iframe width="560" height="315" src="https://www.youtube.com/embed/R82z1DfsKWk" frameborder="0" allowfullscreen></iframe>', 3, 0, now());
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (4, 'a', '<iframe width="560" height="315" src="https://www.youtube.com/embed/C589vlQLQEA" frameborder="0" allowfullscreen></iframe>', 1, 1, now());
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (4, 'b', '<iframe width="560" height="315" src="https://www.youtube.com/embed/zXvg00_5OpM" frameborder="0" allowfullscreen></iframe>', 2, 1, now());
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (4, 'c', '<iframe width="560" height="315" src="https://www.youtube.com/embed/R82z1DfsKWk" frameborder="0" allowfullscreen></iframe>', 3, 1, now());
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (4, 'd', '<iframe width="560" height="315" src="https://www.youtube.com/embed/C589vlQLQEA" frameborder="0" allowfullscreen></iframe>', 4, 1, now());
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (4, 'e', '<iframe width="560" height="315" src="https://www.youtube.com/embed/zXvg00_5OpM" frameborder="0" allowfullscreen></iframe>', 5, 1, now());
insert into video (vi_ca_id, vi_name, vi_tag, vi_rank, vi_status, vi_update_time) values (4, 'f', '<iframe width="560" height="315" src="https://www.youtube.com/embed/R82z1DfsKWk" frameborder="0" allowfullscreen></iframe>', 6, 1, now());
...
insert into admin_view (av_name, av_view_name) values ('編輯診所資訊', 'base-clinic/edit');
...
insert into admin_view (av_name, av_view_name) values ('編輯加盟店資訊', 'base-franchisee/edit');
...
insert into admin_view (av_name, av_view_name) values ('編輯辦事處資訊', 'base-office/edit');
insert into admin_view (av_name, av_view_name) values ('辦事處一覽', 'base-office/list');
insert into admin_view (av_name, av_view_name) values ('新增城市', 'city/add');
insert into admin_view (av_name, av_view_name) values ('編輯城市資訊', 'city/edit');
insert into admin_view (av_name, av_view_name) values ('城市一覽', 'city/list');
insert into admin_view (av_name, av_view_name) values ('新增國家', 'country/add');
insert into admin_view (av_name, av_view_name) values ('編輯國家資訊', 'country/edit');
...
insert into admin_view (av_name, av_view_name) values ('新增相關影音', 'info-video-related/add');
insert into admin_view (av_name, av_view_name) values ('編輯相關影音資訊', 'info-video-related/edit');
insert into admin_view (av_name, av_view_name) values ('相關影音頁面設定', 'info-video-related/list');
...
insert into admin_view (av_name, av_view_name) values ('編輯醫療團隊輪播圖片資訊', 'slider-doctor/edit');
...
insert into admin_view (av_name, av_view_name) values ('編輯加盟店資訊輪播圖片資訊', 'slider-franchisee/edit');
...
insert into admin_view (av_name, av_view_name) values ('編輯醫療新知輪播圖片資訊', 'slider-knowledge/edit');
...
insert into admin_view (av_name, av_view_name) values ('編輯主輪播圖片資訊', 'slider-main/edit');
...
insert into admin_view (av_name, av_view_name) values ('編輯近期活動輪播圖片資訊', 'slider-recent/edit');
...
insert into admin_view (av_name, av_view_name) values ('編輯優惠活動輪播圖片資訊', 'slider-sale/edit');
...
insert into admin_view (av_name, av_view_name) values ('編輯區域資訊', 'state/edit');
...
insert into admin_action (aa_name, aa_action_name) values ('編輯診所資訊', 'base-clinic/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增加盟店', 'base-franchisee/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯加盟店資訊', 'base-franchisee/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增辦事處', 'base-office/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯辦事處資訊', 'base-office/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增城市', 'city/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯城市資訊', 'city/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增國家', 'country/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯國家資訊', 'country/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增相關影音', 'info-video-related/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯相關影音資訊', 'info-video-related/edit.do');
...
insert into admin_action (aa_name, aa_action_name) values ('編輯加盟店資訊輪播圖片資訊', 'slider-franchisee/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增醫療新知輪播圖片', 'slider-knowledge/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯醫療新知輪播圖片資訊', 'slider-knowledge/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增主輪播圖片', 'slider-main/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯主輪播圖片資訊', 'slider-main/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增近期活動輪播圖片', 'slider-recent/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯近期活動輪播圖片資訊', 'slider-recent/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增優惠活動輪播圖片', 'slider-sale/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯優惠活動輪播圖片資訊', 'slider-sale/edit.do');
insert into admin_action (aa_name, aa_action_name) values ('新增醫療團隊輪播圖片', 'slider-doctor/add.do');
insert into admin_action (aa_name, aa_action_name) values ('編輯醫療團隊輪播圖片資訊', 'slider-doctor/edit.do');
