...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'admin/edit-email-repeat.ajax', '信箱重複驗證', 0);
...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'admin/sign-up-email-repeat.ajax', '信箱重複驗證', 1);
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'admin/sign-up-username-repeat.ajax', '帳號重複驗證', 1);
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (2, 'admin/sign-up.do', '註冊', 1);
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'admin/switch.ajax', '帳戶開關', 1);
...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'area-city/choice-state-city-list.ajax', '選定區域中的所有城市', 0);
...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'area-city/switch.ajax', '城市開關', 0);
...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'area-country/switch.ajax', '國家開關', 0);
...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'area-state/choice-country-state-list.ajax', '選定國家中的所有區域', 0);
...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'area-state/switch.ajax', '區域開關', 0);
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'base/switch.ajax', '據點開關', 0);
...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'html/switch.ajax', 'html 開關', 0);
...
insert into admin_path (ap_cp_id, ap_path, ap_name, ap_authority) values (3, 'video/switch.ajax', '影片開關', 0);
