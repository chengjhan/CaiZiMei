	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">新增公司使命頁面</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/about-mission/list?page=1">公司使命頁面一覽</a></li>
						<li class="active">新增公司使命頁面</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/about-mission/add.do" method="post" modelAttribute="htmlBean">
						<table class="table html-table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/about-mission/list?page=1"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
