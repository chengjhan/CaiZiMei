	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">編輯公司使命頁面</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/about-mission/list?page=${currentPage}">公司使命頁面一覽</a></li>
						<li class="active">編輯公司使命頁面</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/about-mission/edit.do" method="post" modelAttribute="htmlBean">
						<table class="table html-table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/about-mission/list?page=${currentPage}"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
