	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">公司願景頁面一覽</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li class="active">公司願景頁面一覽</li>
					</ol>
				
					<!-- option -->
					<div class="btn-group option">
						<div class="add-button">
							<a href="<%=request.getContextPath()%>/about-vision/add" title="新增">
								...
								<tr>
									...
									<td>
										<div class="edit-button">
											<a href="<%=request.getContextPath()%>/about-vision/edit?ht_id=${bean.ht_id}&page=${currentPage}" title="編輯">
						...
						<nav class="page">
							<ul class="pagination">
								<c:if test="${currentPage > 1}">
									<li><a href="<%=request.getContextPath()%>/about-vision/list?page=${currentPage - 1}"><span aria-hidden="true">&laquo;</span><span class="sr-only">Previous</span></a></li>
								</c:if>
								<c:forEach begin="1" end="${pageCount}" varStatus="status">
									<li id="id-li-page-${status.count}"><a href="<%=request.getContextPath()%>/about-vision/list?page=${status.count}">${status.count}</a></li>
								</c:forEach>
								<c:if test="${currentPage < pageCount}">
									<li><a href="<%=request.getContextPath()%>/about-vision/list?page=${currentPage + 1}"><span aria-hidden="true">&raquo;</span><span class="sr-only">Next</span></a></li>
								</c:if>
							</ul>
						</nav>
					</c:if>
