			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/base-franchisee/list?page=${currentPage}">加盟店一覽</a></li>
						<li class="active">編輯加盟店</li>
					</ol>
						...
						<table class="table base-table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/base-franchisee/list?page=${currentPage}"><button type="button" class="btn btn-danger">取消</button></a>	
								</td>
							</tr>
						</table>
					</form:form>
