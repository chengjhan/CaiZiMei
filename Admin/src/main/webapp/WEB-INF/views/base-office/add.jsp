			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/base-office/list?page=1">辦事處一覽</a></li>
						<li class="active">新增辦事處</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/base-office/add.do" method="post" modelAttribute="baseBean">
						<table class="table base-table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/base-office/list?page=1"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
