			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/base-office/list?page=${currentPage}">辦事處一覽</a></li>
						<li class="active">編輯辦事處資訊</li>
					</ol>
	
					<!-- form -->
					<form:form action="/Admin/base-office/edit.do" method="post" modelAttribute="baseBean">
						<table class="table">
