...
<%-- 									<td>${ba_status_time_format}</td> --%>
									<td>
										<div class="edit-button">
											<a href="<%=request.getContextPath()%>/clinic/edit?ba_id=${bean.ba_id}"><img src="<%=request.getContextPath()%>/images/edit.svg"></a>
										</div>
									</td>
									<td>
					...
					<nav>
						<ul class="pagination">
							<li><a href="<%=request.getContextPath()%>/clinic/list?page=1"><span aria-hidden="true">&laquo;</span><span class="sr-only">Previous</span></a></li>
							<li class="active"><a href="">1</a></li>
							<li><a href="<%=request.getContextPath()%>/clinic/list?page=2">2</a></li>
							<li><a href="">3</a></li>
							<li><a href="">4</a></li>
