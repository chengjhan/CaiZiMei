			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/image/list?page=${currentPage}">圖片一覽</a></li>
						<li class="active">編輯圖片</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/image/edit.do" method="post" modelAttribute="imageBean" enctype="multipart/form-data" cssClass="form-horizontal">
						
						<div class="image-upload">
							<label for="image-uploader">
								<div class="image-preview">
									<img src="<%=request.getContextPath()%>/images/image/${imageBean.im_filename}">
								</div>
							</label>
