	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">編輯醫療新知頁面</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/info-knowleage/list?page=${currentPage}">醫療新知頁面一覽</a></li>
						<li class="active">編輯醫療新知頁面</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/info-knowleage/edit.do" method="post" modelAttribute="videoBean">
						<table class="table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/info-knowleage/list?page=${currentPage}"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
