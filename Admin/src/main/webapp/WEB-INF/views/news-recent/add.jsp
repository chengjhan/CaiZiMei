	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">新增近期活動頁面</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/news-recent/list?page=1">近期活動頁面一覽</a></li>
						<li class="active">新增近期活動頁面</li>
					</ol>
						...
						<table class="table html-table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/news-recent/list?page=1"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
