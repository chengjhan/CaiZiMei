		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					<a href="<%=request.getContextPath()%>/office/add">新增</a>
...
<%-- 									<td>${ba_status_time_format}</td> --%>
									<td>
										<div style="width:30px">
											<a href="<%=request.getContextPath()%>/office/edit?ba_id=${bean.ba_id}"><img src="<%=request.getContextPath()%>/images/edit.svg" style="width:100%"></a>
										</div>
									</td>
									<td>
