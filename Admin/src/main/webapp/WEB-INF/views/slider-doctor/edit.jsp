...
<title>編輯醫療團隊輪播圖片 - 采姿美管理系統</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">編輯醫療團隊輪播圖片</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/slider-doctor/list?page=${currentPage}">醫療團隊輪播圖片一覽</a></li>
						<li class="active">編輯醫療團隊輪播圖片</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/slider-doctor/edit.do" method="post" modelAttribute="imageBean" enctype="multipart/form-data" cssClass="form-horizontal">
						
						<div class="image-upload">
							<label for="image-uploader">
								<div class="image-preview">
									<img src="<%=request.getContextPath()%>/images/slider-doctor/${imageBean.im_filename}" />
								</div>
							</label>
						...
						<table class="table image-form-table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/slider-doctor/list?page=${currentPage}"><input type="button" class="btn btn-danger" value="取消" /></a>
								</td>
							</tr>
						</table>
					</form:form>
