...
<title>編輯加盟店資訊輪播圖片資訊 - 采姿美管理系統</title>
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">編輯加盟店資訊輪播圖片資訊</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/slider-franchisee/list?page=${currentPage}">加盟店資訊輪播圖片一覽</a></li>
						<li class="active">編輯加盟店資訊輪播圖片資訊</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/slider-franchisee/edit.do" method="post" modelAttribute="imageBean" enctype="multipart/form-data" cssClass="form-horizontal">
						...
						<table class="table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/slider-franchisee/list?page=${currentPage}"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
	...
	<script>
		...
		$(document).on("click", "#image-reset", function(){
			$("#image-uploader").val("");
			$(".image-preview img").attr("src", "../images/slider-franchisee/${imageBean.im_filename}");
