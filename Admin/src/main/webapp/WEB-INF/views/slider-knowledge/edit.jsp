...
<title>編輯醫療新知輪播圖片資訊 - 采姿美管理系統</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">編輯醫療新知輪播圖片資訊</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/slider-knowledge/list?page=${currentPage}">醫療新知輪播圖片一覽</a></li>
						<li class="active">編輯醫療新知輪播圖片資訊</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/slider-knowledge/edit.do" method="post" modelAttribute="imageBean" enctype="multipart/form-data" cssClass="form-horizontal">
						
						<div class="image-upload">
							<label for="image-uploader">
								<div class="image-preview" style="max-width:533px">
									<img src="<%=request.getContextPath()%>/images/slider-knowledge/${imageBean.im_filename}" class="img-thumbnail">
								</div>
							</label>
							<div id="image-reset">
						...
						<table class="table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/slider-knowledge/list?page=${currentPage}"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
