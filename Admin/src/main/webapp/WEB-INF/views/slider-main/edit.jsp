		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<div>
						<img src="<%=request.getContextPath()%>/images/slider-main/${imageBean.im_filename}">
					</div>
					
					<!-- form -->
					<form:form action="/Admin/slider-main/edit.do" method="post" modelAttribute="imageBean" enctype="multipart/form-data">
						<table>
