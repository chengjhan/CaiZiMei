						...
						<c:forEach var="bean" items="${imageList}" varStatus="status">
							<tbody>
								<tr>
									...
									<td rowspan="4"><img src="<%=request.getContextPath()%>/images/slider-main/${bean.im_filename}" /></td>
									<td>名稱</td>
									<td>${bean.im_name}</td>
									<td rowspan="4">
										<div class="edit-button">
											<a href="<%=request.getContextPath()%>/slider-main/edit?im_id=${bean.im_id}&page=${currentPage}" title="編輯">
