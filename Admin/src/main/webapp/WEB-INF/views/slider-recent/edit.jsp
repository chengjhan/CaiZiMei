...
<title>編輯近期活動輪播圖片資訊 - 采姿美管理系統</title>
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">編輯近期活動輪播圖片資訊</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/slider-recent/list?page=${currentPage}">近期活動輪播圖片一覽</a></li>
						<li class="active">編輯近期活動輪播圖片資訊</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/slider-recent/edit.do" method="post" modelAttribute="imageBean" enctype="multipart/form-data" cssClass="form-horizontal">
						
						<div class="image-upload">
							<label for="image-uploader">
								<div class="image-preview" style="max-width:533px">
									<img src="<%=request.getContextPath()%>/images/slider-recent/${imageBean.im_filename}" class="img-thumbnail">
								</div>
							</label>
							<div id="image-reset">
						...
						<table class="table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/slider-recent/list?page=${currentPage}"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
	...
	<script>
		...
		$(document).on("click", "#image-reset", function(){
			$("#image-uploader").val("");
			$(".image-preview img").attr("src", "../images/slider-recent/${imageBean.im_filename}");
