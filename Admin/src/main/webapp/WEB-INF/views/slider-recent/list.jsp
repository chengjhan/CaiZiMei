			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li class="active">近期活動輪播圖片一覽</li>
					</ol>
				
					<!-- option -->
					<div class="btn-group option">
						<div class="add-button">
							<a href="<%=request.getContextPath()%>/slider-recent/add" title="新增">
								...
								<tr>
									...
									<td rowspan="4" style="width:50px">
										<div class="edit-button">
											<a href="<%=request.getContextPath()%>/slider-recent/edit?im_id=${bean.im_id}&page=${currentPage}" title="編輯">
