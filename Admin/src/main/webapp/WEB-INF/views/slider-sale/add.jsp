			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/slider-sale/list?page=1">優惠活動輪播圖片一覽</a></li>
						<li class="active">新增優惠活動輪播圖片</li>
					</ol>
						...
						<table class="table image-table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/slider-sale/list?page=1"><button type="button" class="btn btn-danger">取消</button></a>
