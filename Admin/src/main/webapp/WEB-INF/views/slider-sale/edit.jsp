...
<title>編輯優惠活動輪播圖片 - 采姿美管理系統</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">編輯優惠活動輪播圖片</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/slider-sale/list?page=${currentPage}">優惠活動輪播圖片一覽</a></li>
						<li class="active">編輯優惠活動輪播圖片</li>
					</ol>
						...
						<div class="image-upload">
							<label for="image-uploader">
								<div class="image-preview">
									<img src="<%=request.getContextPath()%>/images/slider-sale/${imageBean.im_filename}">
								</div>
							</label>
						...
						<table class="table image-table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/slider-sale/list?page=${currentPage}"><button type="button" class="btn btn-danger">取消</button></a>
