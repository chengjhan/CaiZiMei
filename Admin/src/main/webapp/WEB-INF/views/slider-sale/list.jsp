				...
				<div class="table-responsive">
					...
					<div class="btn-group option">
						<div class="add-button">
							<a href="<%=request.getContextPath()%>/slider-sale/add">
								...
								<tr>
									...
									<td rowspan="4" style="width:50px">
										<div class="edit-button">
											<a href="<%=request.getContextPath()%>/slider-sale/edit?im_id=${bean.im_id}&page=${currentPage}"><img src="<%=request.getContextPath()%>/images/icon_edit.svg"></a>
										</div>
									</td>	
									<td rowspan="4" style="width:50px">
