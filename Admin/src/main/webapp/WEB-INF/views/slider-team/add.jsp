			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/slider-team/list?page=1">醫療團隊輪播圖片一覽</a></li>
						<li class="active">新增醫療團隊輪播圖片</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/slider-team/add.do" method="post" modelAttribute="imageBean" enctype="multipart/form-data">
						...
						<table class="table">
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/slider-team/list?page=1"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
