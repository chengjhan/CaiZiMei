	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- title -->
				<h2 class="sub-header">新增醫療團隊頁面</h2>
				...
				<div class="table-responsive">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<%=request.getContextPath()%>/team-doctor/list?page=1">醫療團隊頁面一覽</a></li>
						<li class="active">新增醫療團隊頁面</li>
					</ol>
				
					<!-- form -->
					<form:form action="/Admin/team-doctor/add.do" method="post" modelAttribute="htmlBean">
						<table class="table">
							<tr>
							...
							<tr>
								...
								<td>
									...
									<a href="<%=request.getContextPath()%>/team-doctor/list?page=1"><button type="button" class="btn btn-danger">取消</button></a>
								</td>
							</tr>
						</table>
					</form:form>
