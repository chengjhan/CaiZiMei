...
public class ClinicUserController {
	 ...
	 */
	@RequestMapping(path = "/clinic/secure/sign-in.do", method = RequestMethod.POST)
	 ...
	 */
	@RequestMapping(path = "/clinic/secure/forget-password.do", method = RequestMethod.POST)
	public String forgetPasswordProcess(@RequestParam(name = "cu_email") String cu_email, Model model) {

		int random = (int) (Math.random() * 1000000);
		String cu_password_random = String.valueOf(random);

		ClinicUserBean clinicUserBean = clinicUserService.selectByCu_email(cu_email);
		...
		return "redirect:/clinic/secure/set-password";
	}
	 ...
	 * @param clinic-->Session
	 * @param sessionStatus-->SessionStatus
	 * @return /WEB-INF/views/clinic/secure/sign-in.jsp
	 * @return /WEB-INF/views/clinic/secure/set-password.jsp
	 */
	@RequestMapping(path = "/clinic/secure/set-password.do", method = RequestMethod.POST)
	public String setPasswordProcess(@RequestParam(name = "cu_password") String cu_password,
		...
		if (oldHashedPassword.equals(inputOldHashedPassword)) {
			...
			return "redirect:/clinic/secure/sign-in";
		} else {
	 ...
	 * @return /WEB-INF/views/clinic/secure/sign-in.jsp
	 */
	@RequestMapping(path = "/clinic/secure/sign-out.do", method = RequestMethod.GET)
	 ...
	 */
	@RequestMapping(path = "/admin/clinic-user/sign-up.do", method = RequestMethod.POST)
	public String signUpProcess(ClinicUserBean clinicUserBean, @RequestParam(name = "cu_username") String cu_username,
		...
		if (clinicUserService.selectByCu_username(cu_username) == null) {
			...
			return "redirect:/admin/clinic-user/sign-up";
		}
	}
	 ...
	 */
	@RequestMapping(path = "/clinic/user/update.do", method = RequestMethod.POST)
	public String updateProcess(@ModelAttribute("clinic") ClinicUserBean clinic, ClinicUserBean clinicUserBean) {
		...
		return "redirect:/clinic/user/profile";
	}
