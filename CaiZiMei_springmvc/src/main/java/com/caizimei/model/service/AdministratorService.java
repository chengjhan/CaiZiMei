...
public interface AdministratorService {
	...
	AdministratorBean selectByM_id(Integer a_id);

	AdministratorBean selectByM_username(String a_username);

	AdministratorBean update(AdministratorBean administratorBean);

	AdministratorBean updateM_password(Integer a_id, String a_password_new, String a_salt);

	AdministratorBean updateM_signin_ip(Integer a_id, String a_signin_ip);

	AdministratorBean updateM_signin_time(Integer a_id);
